...
public class ObjectPosition extends CSVConfigurationFile {
    ...
    public ObjectPosition() {
        ...
        //file ="H:\\my university files\internship now\27april2020csv\gitlab\data2rdf-master\src\main\resources\imageHasOnLeftRightCenterTopBottom.csv";
        file ="H:\\my university files\\internship now\\27april2020csv\\gitlab\\data2rdf-master\\src\\main\\resources\\imageHasOnLeftRightCenterTopBottom.csv";
        ...
        public ArrayList<Triple> function(Node subject, HashMap<String, String> article) {
            ...
            for (String a : article.keySet()) {
                if (a.contains("Image name")) {
                    subject = utility.createURI(ObjectPosition.baseUrl + article.get(a));
